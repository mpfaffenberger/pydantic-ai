...
| [Amazon Bedrock](https://docs.aws.amazon.com/bedrock/latest/userguide/conversation-inference.html) | Converse document citations | `include_citations=True` enables citations for inline documents | Citation locations within the source document remain in `provider_details`; the generated text block is the normalized content anchor |
